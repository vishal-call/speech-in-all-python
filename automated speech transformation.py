...
def Text_to_speech():
    ...
    speech.save('sound11.mp3')
    playsound('sound11.mp3')
   # os.remove('sound.mp3')
def Exit():
    root.destroy()
def Reset():
    Msg.set("")
speech_btn = Button(root, text = 'play',font = 'arial 12 bold',pady = 5,command = Text_to_speech, bg = 'royal blue1', activebackground = 'sky blue')
speech_btn.place(x = 540, y= 180 )
